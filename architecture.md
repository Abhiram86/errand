...
- `_genericIntent` passes the normalized Android intent request through unchanged after validating the target and supported extra types. It does not guess aliases or manufacture app-specific extras.
