...
class _StreamingAssistantText extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GptMarkdown(
      ...
      onLinkTap: (url, _) => _openChatFileLink(context, url),
    );
  }

  /// Opens chat links: `file://` (and bare local paths) via the sandboxed
  /// file flow below, http(s) in the external browser. Anything else ignored.
  Future<void> _openChatFileLink(BuildContext context, String url) async {
