...
void main() {
  group('Slice 4: Headless AgentRunner Integration', () {
    ...
    test('runHeadless executes turn and writes output markdown to scratch', () async {
      ...
      expect(reportFile.path, contains('task_10_'));
      expect(await reportFile.readAsString(), equals(result.output));
    });
