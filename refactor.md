...
> **Last updated:** 2026-09-23 | **Status:** v0.7.3 shipped (headless streaming runner, drift-free anchor grid recurring scheduler, notify on fresh kill, schema v8, modularized architecture) | **Schema:** Drift v8 (memories, scheduler_tasks, scheduler_task_logs + indexes)
