...
> **Last updated:** 2026-09-17 | **Status:** v0.6.2 shipped (filesystem hygiene, Documents/Errand working directory, scratch cache) | **Schema:** Drift v5 (memories) + `compacted` rows
